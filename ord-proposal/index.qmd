...
Though we hope to extend the approach suggested in this proposal to other fields in the future, we intend to focus on our 'homecourt' disciplines of official statistics and empirical economics in this *Explore* proposal.
We are confident that the strength of our network in both of these fields will help leverage our initial *Explore* push enough to give the impact of our project a great chance to spill over to other disciplines and their communities. Therefore, we present our background and motivation in order to contextualize our ideas with the example application we intend to *explore* in the proposed project.
