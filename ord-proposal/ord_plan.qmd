...
The goal of Work Package 3 (WP3) is to create a community around opnts. This ensures that the opnts framework can not only improve its core packages (through feedback from the community) but also expand its application into different academic fields. 

### Implementation

This will be done in three ways: the opnts data and software package will be integrated into academic teaching aimed at scientists of diverse fields, the "R of Official Statistics" conference will be hosted, and community events will be planned which enable a get-together of different competencies. 

- academic teaching -> opnts in h4sci bec. practice working with machine readable data, etc. 
...
- host a [uRosConf](https://r-project.ro/conference2023.html) 2024 
- integrate opnts into existing community events (RSE @ ETH, RSECON 2024, RSEED meet-up series)
