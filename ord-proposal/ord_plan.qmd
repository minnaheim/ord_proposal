...
Our approach uses license cost free open source software and aims to publish not only time series data but also the technical framework and infrastructure setup in order to ensure reproducibility and comply with FAIR principles. Thanks to our infrastructure-as-code approach we can publish information on an ideal runtime environment in order to help others to operate an instance of the *opents* framework.
