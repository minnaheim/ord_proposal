...
Work package WP2 publishes all components of our work: The publication of machine ingestion friendly datasets and descriptions facilitates scientific use and makes it easier for the users of the data to work in reproducible fashion. Through publication of our processing framework, we apply the same standards to our work and communicate ORD practices across disciplines using code as an interdisciplinary channel. Finally, through the publication of an infrastructure sketch that is capable of operating our processing framework, we aim to lower the barrier for researchers to run processes that make datasets machine readable in their respective fields.
